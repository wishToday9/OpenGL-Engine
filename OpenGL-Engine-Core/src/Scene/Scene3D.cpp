...
namespace OpenGL_Engine {
	...
	void Scene3D::init() {
		...
		//m_RenderableModels.push_back(new RenderableModel(glm::vec3(67.0f, 110.0f, 133.0f), glm::vec3(0.1f, 0.1f, 0.1f),
		//	glm::vec3(0.0f, 1.0f, 0.0f), glm::radians(180.0f), sponza, nullptr, true, false));
